...
static __inline uint32_t mwc1_current(SimpleRandomMWC1_t * p_mwc)
{
...
static __inline uint32_t mwc2_current(SimpleRandomMWC2_t * p_mwc)
{
...
static __inline uint32_t kiss_current(SimpleRandomKISS_t * p_kiss)
{
    uint32_t    mwc2;
    uint32_t    cong;
    uint32_t    shr3;
...
static __inline uint32_t kiss2_current(SimpleRandomKISS2_t * p_kiss2)
{
