 ...
 */
static __inline void mwc2_sanitize_upper(SimpleRandomMWC2_t * p_mwc)
{
    uint32_t    state_orig;
    uint32_t    temp;
 ...
 */
static __inline void mwc2_sanitize_lower(SimpleRandomMWC2_t * p_mwc)
{
    uint32_t    state_orig;
    uint32_t    temp;
...
static __inline void mwc2_next_upper(SimpleRandomMWC2_t * p_mwc)
{
    p_mwc->mwc_upper = 36969u * (p_mwc->mwc_upper & 0xFFFFu) + (p_mwc->mwc_upper >> 16u);
}

static __inline void mwc2_next_lower(SimpleRandomMWC2_t * p_mwc)
{
 ...
 * Any integer multiple of 0x9068FFFF, including 0, is a bad state.
 */
static __inline void kiss_sanitize_mwc_upper(SimpleRandomKISS_t * p_kiss)
{
    uint32_t    state_orig;
    uint32_t    temp;
 ...
 * Any integer multiple of 0x464FFFFF, including 0, is a bad state.
 */
static __inline void kiss_sanitize_mwc_lower(SimpleRandomKISS_t * p_kiss)
{
    uint32_t    state_orig;
    uint32_t    temp;
...
static __inline void kiss_sanitize_shr3(SimpleRandomKISS_t * p_kiss)
{
    /* Zero is a bad state value for SHR3. */
    if (p_kiss->shr3 == 0)
    {
...
static __inline void kiss_next_mwc_upper(SimpleRandomKISS_t * p_kiss)
{
    p_kiss->mwc_upper = 36969u * (p_kiss->mwc_upper & 0xFFFFu) + (p_kiss->mwc_upper >> 16u);
}

static __inline void kiss_next_mwc_lower(SimpleRandomKISS_t * p_kiss)
{
    p_kiss->mwc_lower = 18000u * (p_kiss->mwc_lower & 0xFFFFu) + (p_kiss->mwc_lower >> 16u);
}

static __inline void kiss_next_cong(SimpleRandomKISS_t * p_kiss)
{
    p_kiss->cong = UINT32_C(69069) * p_kiss->cong + 12345u;
}

static __inline void kiss_next_shr3(SimpleRandomKISS_t * p_kiss)
{
    uint32_t    shr3;
...
static __inline uint32_t mwc64_current(SimpleRandomMWC64_t * p_mwc)
{
...
static __inline void kiss2_sanitize_mwc64(SimpleRandomKISS2_t * p_kiss2)
{
    uint64_t    state64_orig;
    uint64_t    temp64;
    bool        was_changed = false;
...
static __inline void kiss2_sanitize_shr3(SimpleRandomKISS2_t * p_kiss2)
{
    /* Zero is a bad state value for SHR3. */
    if (p_kiss2->shr3 == 0)
    {
...
static __inline void kiss2_next_mwc64(SimpleRandomKISS2_t * p_kiss2)
{
    uint64_t    mwc64;
...
static __inline void kiss2_next_cong(SimpleRandomKISS2_t * p_kiss2)
{
    p_kiss2->cong = UINT32_C(69069) * p_kiss2->cong + 12345u;
}

static __inline void kiss2_next_shr3(SimpleRandomKISS2_t * p_kiss2)
{
    uint32_t    shr3;
 ...
 */
static __inline void lfsr113_sanitize_z1(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    working_seed;
...
static __inline void lfsr113_sanitize_z2(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    working_seed;
...
static __inline void lfsr113_sanitize_z3(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    working_seed;
...
static __inline void lfsr113_sanitize_z4(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    working_seed;
...
static __inline void lfsr113_next_z1(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    b;
    uint32_t    z1;
...
static __inline void lfsr113_next_z2(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    b;
    uint32_t    z2;
...
static __inline void lfsr113_next_z3(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    b;
    uint32_t    z3;
...
static __inline void lfsr113_next_z4(SimpleRandomLFSR113_t * p_lfsr113)
{
    uint32_t    b;
    uint32_t    z4;
...
static __inline uint32_t lfsr113_current(SimpleRandomLFSR113_t * p_lfsr113)
{
...
static __inline void lfsr88_sanitize_z1(SimpleRandomLFSR88_t * p_lfsr88)
{
    uint32_t    working_seed;
...
static __inline void lfsr88_sanitize_z2(SimpleRandomLFSR88_t * p_lfsr88)
{
    uint32_t    working_seed;
...
static __inline void lfsr88_sanitize_z3(SimpleRandomLFSR88_t * p_lfsr88)
{
    uint32_t    working_seed;
...
static __inline void lfsr88_next_z1(SimpleRandomLFSR88_t * p_lfsr88)
{
    uint32_t    b;
    uint32_t    z1;
...
static __inline void lfsr88_next_z2(SimpleRandomLFSR88_t * p_lfsr88)
{
    uint32_t    b;
    uint32_t    z2;
...
static __inline void lfsr88_next_z3(SimpleRandomLFSR88_t * p_lfsr88)
{
    uint32_t    b;
    uint32_t    z3;
...
static __inline uint32_t lfsr88_current(SimpleRandomLFSR88_t * p_lfsr88)
{
